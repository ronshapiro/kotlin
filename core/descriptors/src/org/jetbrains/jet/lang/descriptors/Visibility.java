...
public abstract class Visibility {
    ...
    */
    ...
    protected abstract boolean isVisible(@NotNull ReceiverValue thisObject, @NotNull DeclarationDescriptorWithVisibility what, @NotNull DeclarationDescriptor from);
}
