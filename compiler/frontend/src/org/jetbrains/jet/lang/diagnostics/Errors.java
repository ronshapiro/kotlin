...
public interface Errors {
    ...
    DiagnosticFactory1<PsiElement, VarianceConflictDiagnosticData>
            TYPE_PARAMETER_VARIANCE_CONFLICT = DiagnosticFactory1.create(ERROR, DECLARATION_SIGNATURE_OR_DEFAULT);
